...
class Book {
  ...
  // Constructor - will run when creating an Art object
    Book (this.id,this.title,this.loanadm,this.date,this.extended,this.reserved,this.onloan,this.location);
}
...
class services {
  ...
  static CollectionReference profile= FirebaseFirestore.instance.collection("profile");
  static CollectionReference book= FirebaseFirestore.instance.collection("books");
  //download all firebase profiles to local
  static Future<void> getAllProfile()
  async{
    profilelist.clear();
  ...
  async{
    ...
    DocumentSnapshot doc = qs.docs[i];
    Map<String, dynamic> data = doc.data() as Map<String, dynamic>;   
    booklist.add(Book(data["id"],data["title"],data["loanadm"],data["date"],data["extended"],data["reserved"],data["onloan"],data["location"]),);
    
    
    if(data["onloan"]!=true&&data["reserved"]!=true&&data["location"]==tappedLocation)
    {
      loanable.add(Book(data["id"],data["title"],data["loanadm"],data["date"],data["extended"],data["reserved"],data["onloan"],data["location"]),);
    }
    if(data["loanadm"]==adm)
    {
      reservedlist.add(Book(data["id"],data["title"],data["loanadm"],data["date"],data["extended"],data["reserved"],data["onloan"],data["location"]),);
    }
    
    }
  }
  static Future<void> reserveBook(int index)
  async{
  ...
  static Future<void> addbook(String id,String title,String loanadm,String date,bool extended,bool reserved,bool onloan, String location)
  async{
    ...
    booklist.add(Book(id,title,loanadm,date,extended,reserved,onloan,location,));
